                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); ++i) {
                            try {
                                ...
                                String imageUrl = hotspot.getString("photo_link");
                                ...
                                hotspotItemArrayList.add(new HotspotItem(0, imageUrl, new LatLng(Latitude, Longitude), speciesName, sites, endemics, priority, status, family));
